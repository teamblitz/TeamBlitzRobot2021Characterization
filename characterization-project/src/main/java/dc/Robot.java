...
public class Robot extends TimedRobot {
  ...
  static private double ENCODER_EDGES_PER_REV = 2048.0;
  static private int PIDIDX = 0;
  static private int ENCODER_EPR = 2048;
  static private double GEARING = 4.2857;

  private double encoderConstant = (1 / GEARING) * (1 / ENCODER_EDGES_PER_REV) *0.50;
    ...
    if (side != Sides.FOLLOWER) {
      ...
      switch (side) {
        ...
        case RIGHT:
          ...
          rightEncoderRate = () -> motor.getSelectedSensorVelocity(PIDIDX) * encoderConstant * 10;
  ...
  public void robotInit() {
    ...
    WPI_TalonFX rightMotor = setupWPI_TalonFX(8, Sides.RIGHT, false);
